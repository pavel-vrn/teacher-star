...
function tribute_scripts() {
	     wp_enqueue_script('yds-jquery', get_template_directory_uri() . '/js/jquery.min.js', array(), '1.11.3' );
	     wp_enqueue_script('flexslider_jquery', get_template_directory_uri() .'/js/flexslider.min.js', array(),true );
